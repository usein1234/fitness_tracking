...
class CaloriesDataPage extends StatelessWidget {
    ...
    return Scaffold(
      body: ScopedModelDescendant<MainModel>(
          builder: (BuildContext context, Widget child, MainModel model) {
            if(model.statusPage3 == 0){
              model.makeCaloriesRequest();
            }
        return Container(
            ...
            children: <Widget>[
              Column(
                children: <Widget>[
                  ...
                  Container(
                    ...
                    child: TimeSeriesBar(
                      model.createBarChartCalories(model.chartCaloriesData),
                      animate: true,
                    ),
                  ),
                ],
              ...
              Row(
                ...
                children: <Widget>[
                  ...
                  FlatButton(
                    onPressed: () {
                      model.getMonthCaloriesData();
                      Navigator.pushNamed(context, '/trainee/stat/calories');
                    },
